...
r1 = left_column.slider(label=r"$\rho_1$", min_value=0.0, max_value=10.0, step=0.1, value=1.0)
a1 = left_column.slider(label=r"$\alpha_1$", min_value=0.0, max_value=10.0, step=0.1, value=1.5)
b1 = left_column.slider(label=r"$\beta_1$", min_value=0.0, max_value=10.0, step=0.1, value=0.0)
r2 = right_column.slider(label=r"$\rho_2$", min_value=0.0, max_value=10.0, step=0.1, value=2.0)
